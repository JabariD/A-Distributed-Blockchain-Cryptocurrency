...
class Blockchain:
    ...
    def __init__(self):
        ...
        # list of transacations before they are added to a block
        self.transacations = []
    ...
    def create_block(self, proof, previous_hash):
        ...
        block = {'index': len(self.chain) + 1, # the index of this block
                 ...
                 "transacations": self.transacations
                 } 
    ...
    def add_transacation(self, sender, receiver, amount):
        # simply add to list of Txns
        self.transacations.append({"sender": sender, "receiver": receiver, "amount":amount})
...
def mine_block():
    ...
    blockchain.add_transacation(sender=node_address, receiver="Node 5003", amount=1)
...
def add_transaction():
    ...
    index = blockchain.add_transacation(json["sender"], json["receiver"], json["amount"])
